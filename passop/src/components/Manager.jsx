...
const Manager = () => {
  ...
  return (
    <>
      ...
      <div className='p-2 md:p-0 md:mycontainer min-h-[87.8vh]'>
        ...
        <div className="flex flex-col p-4 text-black gap-8 items-center">
          ...
          <button onClick={savePassword} className='flex justify-center text-black font-bold hover:bg-green-400 gap-2 items-center bg-green-500 rounded-full px-3 py-2 w-fit border border-green-700'>
            <lord-icon
